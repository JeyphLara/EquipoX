...
class InventoryControllerTest {
     ...
     * // Arrange
     * InventoryModel mockInventory = new InventoryModel(1L, "P001", "Product 1",
     * 10, LocalDateTime.now(), null);
     * when(inventoryService.getInventoryById(1L)).thenReturn(Optional.of(
     * mockInventory));
     * 
     * // Act
     * ResponseEntity<InventoryModel> response =
     ...
     * // Arrange
     * InventoryModel updatedInventory = new InventoryModel(1L, "P001",
     * "Updated Product", 15, LocalDateTime.now(),
     * null);
     * when(inventoryService.updateInventory(eq(1L),
     * any(InventoryModel.class))).thenReturn(updatedInventory);
     * 
     * // Act
     * ResponseEntity<InventoryModel> response =
     * inventoryController.updateInventory(1L, updatedInventory);
     * 
     * // Assert
     * assertNotNull(response);
     * assertEquals(200, response.getStatusCodeValue());
     * assertEquals(updatedInventory, response.getBody());
     * verify(inventoryService, times(1)).updateInventory(eq(1L),
     * any(InventoryModel.class));
     * }
     * 
     * @Test
     ...
     * // Act
     * ResponseEntity<InventoryModel> response =
     * inventoryController.updateInventory(1L, new InventoryModel());
     * 
     * // Assert
     * assertNotNull(response);
     * assertEquals(404, response.getStatusCodeValue());
     ...
     * inventoryController.searchProducts("Product");
     * 
     * // Assert
     * assertNotNull(response);
     * assertEquals(200, response.getStatusCodeValue());
